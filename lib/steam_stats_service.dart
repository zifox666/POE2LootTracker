...
/// point than scraping SteamDB's rendered chart page.  The UI links users to SteamDB for its full
...
class SteamStatsService {
  ...
  Future<int> currentPlayers() async {
    final request = await _client.getUrl(
      Uri.https('api.steampowered.com', '/ISteamUserStats/GetNumberOfCurrentPlayers/v1/', {
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw HttpException('Steam player count failed (HTTP ${response.statusCode}).');
    }
